...
{
	initShader(L"tessellation_vs.cso", L"tessellation_quad_hs.cso", L"tessellation_quad_ds.cso", L"normals_gs.cso", L"tessellation_ps.cso");
}
...
void TessellationQuadShader::initShader(WCHAR* vsFilename, WCHAR* hsFilename, WCHAR* dsFilename, WCHAR* gsFilename, WCHAR* psFilename)
{
