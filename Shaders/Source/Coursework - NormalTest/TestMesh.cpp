...
TestMesh::TestMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext)
{
	initBuffers(device);
}
...
void TestMesh::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void TestMesh::sendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
